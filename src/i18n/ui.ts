...
export const ui = {
  en: {
    ...
    "nav.theme": "Themes",
    "hero.subtitle":
      "Visit photos on any devices. Supported apps with eagle, normal folder, picall and billfish.",
    ...
    "feature.4":
      "Rao.Pics supports eagle, billfish and picall and more and more.",
  ...
  zh: {
    ...
    "nav.theme": "主题",
    "hero.subtitle":
      "在任何设备上访问照片。<br />支持 eagle、普通文件夹、picall 和 billfish。",
    ...
    "feature.4": "Rao.Pics 支持 eagle、billfish、picall 等等，还会支持更多。",
